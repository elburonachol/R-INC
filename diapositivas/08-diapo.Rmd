...
.font140[
Los bloques de código se agregan dentro del documento de texto Rmarkdown mediante *"fragmentos"* (**chunk**) a partir de insertar (Ctrl+Alt+I) un bloque con los siguientes delimitadores ````{r}` y `````.
...
Para tomar como referencia el archivo Word modificado en su estilo se incorpora dentro de la cabecera YAML del Rmarkdown un argumento `reference_docx` dela siguiente forma:
