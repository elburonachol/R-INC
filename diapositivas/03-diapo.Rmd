...
```{r, eval=F}
# Coercionamos la variable FENAC aplicando la función dmy() de lubridate
...
```{r, eval=F}
# Resumimos la variable DGED calculando media, desvío estandar, mínimo y máximo
...
```{r, eval=F}
# Resumimos la variable DGED según PTESEXN calculando media, desvío estandar, mínimo y máximo
...
# Contamos las frecuencias de la variable IDESTN ordenadas de mayor a menor
